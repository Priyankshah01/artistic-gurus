...
const cardData = [
  {
    color: "#060010",
    title: "Development",
    description: "Webflow and Next.js",
    label: "Portfolio & Brand Website Design",
  },
  {
    color: "#060010",
  ...
  {
    color: "#060010",
    title: " Convert traffic from ads or email campaigns",
    description: "Copy-driven layouts, A/B test-ready design, hero sections, CTA placements, analytics hooks",
    label: "Conversion-Focused Landing Pages",
  },
  {
    color: "#060010",
    title: "Design Consulting",
    description: "Heuristic evaluation, user journey mapping, UX pain points report, suggestions for fixes.",
    label: "UX Audits",
  },
  {
    color: "#060010",
    title: "iOS & Android",
    description: "App UX flows & Design",
